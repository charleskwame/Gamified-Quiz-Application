...
class LevelSystem {
  ...
  static const List<LevelDef> levels = [
    ...
    LevelDef(level: 2, name: 'Amateur', xpRequired: 250),
    LevelDef(level: 3, name: 'Scholar', xpRequired: 600),
    LevelDef(level: 4, name: 'Apprentice', xpRequired: 1200),
    LevelDef(level: 5, name: 'Specialist', xpRequired: 2000),
    LevelDef(level: 6, name: 'Expert', xpRequired: 3000),
    LevelDef(level: 7, name: 'Master', xpRequired: 4500),
    LevelDef(level: 8, name: 'Grandmaster', xpRequired: 6500),
    LevelDef(level: 9, name: 'Legend', xpRequired: 9000),
    LevelDef(level: 10, name: 'Mythic', xpRequired: 12000),
    LevelDef(level: 11, name: 'Transcendent', xpRequired: 16000),
    LevelDef(level: 12, name: 'Immortal', xpRequired: 21000),
    LevelDef(level: 13, name: 'Cosmic', xpRequired: 27000),
    LevelDef(level: 14, name: 'Celestial', xpRequired: 34000),
    LevelDef(level: 15, name: 'Divine', xpRequired: 44000),
  ];
