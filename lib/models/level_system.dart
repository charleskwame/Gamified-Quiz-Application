...
class LevelSystem {
  ...
  static const List<LevelDef> levels = [
    ...
    LevelDef(level: 2, name: 'Amateur', xpRequired: 100),
    LevelDef(level: 3, name: 'Scholar', xpRequired: 300),
    LevelDef(level: 4, name: 'Apprentice', xpRequired: 600),
    LevelDef(level: 5, name: 'Specialist', xpRequired: 1000),
    LevelDef(level: 6, name: 'Expert', xpRequired: 1500),
    LevelDef(level: 7, name: 'Master', xpRequired: 2200),
    LevelDef(level: 8, name: 'Grandmaster', xpRequired: 3000),
    LevelDef(level: 9, name: 'Legend', xpRequired: 4000),
    LevelDef(level: 10, name: 'Mythic', xpRequired: 5500),
    LevelDef(level: 11, name: 'Transcendent', xpRequired: 7500),
    LevelDef(level: 12, name: 'Immortal', xpRequired: 10000),
    LevelDef(level: 13, name: 'Cosmic', xpRequired: 13000),
    LevelDef(level: 14, name: 'Celestial', xpRequired: 17000),
    LevelDef(level: 15, name: 'Divine', xpRequired: 22000),
  ];
